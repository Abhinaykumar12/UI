...
App.factory('Data', function(){
    var remote = "http://Default-Environment-7mcjqmmfd3.elasticbeanstalk.com";
    var local = "http://localhost:8080/myChild4";
    var currentUsed =remote;
    return {
...
App.controller('uiSelectController', ["$scope", "$http", function($scope, $http) {
  ...
  $scope.people = [
    ...
    { name: 'Estefan, email: 'estefanemail.com', age: 16 },
